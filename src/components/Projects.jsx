    ...
    <section id='projects' className='relative py-20 overflow-hidden'>
      <div>
        <h2
            data-aos="fade-up"
            data-aos-delay="100"
            className="flex w-full items-center justify-center text-3xl sm:text-4xl lg:text-5xl
      ...
      overflow-hidden w-full px-4'>
        {infiniteProjects.map((project, index) => (
          <div
          key={`${project.id}-${index}`}
          className='w-full md:w-[calc(50%-12px)]
          lg:w-[calc(33.333%-16px)] shrink-0 snap-start group
          ...
          hover:border-red-500/50 dark:hover:border-red-500/50 hover:shadow-[0_20px_40px_rgba(220,38,0,15)]
          flex flex-col'>
            ...
            grow min-h-50'>
              ...
              pt-2 border-t dark:border-zinc-800/80
              border-gray-100'>
                <a
                href='#'
                target='_blank'
                ...
                text-xs font-medium transition-colours
